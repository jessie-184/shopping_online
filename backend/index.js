...
mongoose.connect("mongodb+srv://uyenhieuquach:110821@cluster0.4m6fhft.mongodb.net/shopping-online");
...
app.post('/signup', async (req, res) => {
    ...
    if (check) {
        return res.status(400).json({success:false, errors:"This email has already been registered!"});
    }
    let cart = {};
    for (let i = 0; i < 300; i++) {
        cart[i] = 0;
...
app.post('/login', async (req, res) => {
    ...
    if(user) {
        ...
        res.json({success: false, errors: "This email has not been registered!"});
    }
})
...
// Add to Cart API
app.post('/add_cart', fetchUser, async (req, res) => {
...
app.post('/remove_cart', fetchUser, async (req, res) => {
